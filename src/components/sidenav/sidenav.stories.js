...
storiesOf('Sidenav', module)
  ...
  .add('With Sidenav-Push', () => ( 
    <main className="body-wrapper sidenav-push">
      ...
      <aside className="sidenav">
        ...
        <ul className="sidenav-body">
          <ul class="sidenav-menu">
              ...
              <li>
                <a href="#" class="menu-title"><span>Submenu 2</span></a>
              </li>
              <li>
                <a href="#" class="menu-title"><i class="fas fa-home"></i><span>Submenu 3</span></a>
              </li>
              <li><a href="#" class="menu-title "><i class="fas fa-fan"></i><span>Submenu 4</span></a></li>
          </ul>
        </ul>
      </aside>
  ...
  .add('With Sidenav-partial-push', () => ( 
    <main className="body-wrapper sidenav-partial-push">
      ...
      <aside className="sidenav">
        ...
        <ul className="sidenav-body">
          <ul class="sidenav-menu">
              <li class="is-submenu">
                <a href="#" class="menu-title"><i class="fas fa-university"></i><span>Submenu 2</span></a>
                <ul class="submenu">
                  <li><a class="#/">Submenu 1</a></li>
                  <li><a class="#/">Submenu 2</a></li>
                  <li><a class="#/">Submenu 3</a></li>
                  <li><a class="#/">Submenu 4</a></li>
                </ul>
              </li>
              <li class="is-submenu">
                <a href="#" class="menu-title"><i class="fas fa-home"></i><span>Submenu 3</span></a>
